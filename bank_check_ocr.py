# USAGE
# python3 bank_check_ocr.py --image example_check.png
...
def extract_digits_and_symbols(image, charCnts, minW=5, minH=15):
    ...
    # lists, respectively
    charContourIter = charCnts.__iter__()
    rois = []
    locs = []
...
refROIs = extract_digits_and_symbols(ref, refContours, minW=10, minH=20)[0]
chars = {}
...
groupContours = cv2.findContours(thresh.copy(), cv2.RETR_EXTERNAL,
                                 cv2.CHAIN_APPROX_SIMPLE)
groupContours = imutils.grab_contours(groupContours)
groupLocs = []
